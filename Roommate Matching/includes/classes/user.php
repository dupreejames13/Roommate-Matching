...
class User{
    ...
    protected $user_owl;
    protected $user_early;
    protected $user_smoker;
    ...
    // SING UP USER
    function signUpUser($username, $email, $password, $owl, $early, $smoker, $gender){
        try{
            ...
            if(!empty($this->user_name) && !empty($this->user_email) && !empty($this->user_pass)){
                ...
                if (filter_var($this->user_email, FILTER_VALIDATE_EMAIL)) { 
                    ...
                    if($check_email->rowCount() > 0){
                        ...
                        $sql = "INSERT INTO `users` (username, user_email, user_password, user_image, owl, riser, smoker, Gender) VALUES(:username, :user_email, :user_pass, :user_image, :user_owl, :user_early, :user_smoker, :user_gender)";
                        ...
                        $sign_up_stmt->bindValue(':user_owl',$this->user_owl, PDO::PARAM_BOOL);
                        $sign_up_stmt->bindValue(':user_early',$this->user_early, PDO::PARAM_BOOL);
                        $sign_up_stmt->bindValue(':user_smoker',$this->user_smoker, PDO::PARAM_BOOL);
                        $sign_up_stmt->bindValue(':user_gender',$this->user_gender, PDO::PARAM_INT);
