...
<div class="profileInfo">
		<p>Name: <?php echo $data['username']; ?></td></p>
    		<p>User ID: <?php echo $data['id']; ?></td></p>
    		<p>User Email: <?php echo $data['user_email']; ?></td> </p>
	</div>
                ...
                elseif($check_req_receiver){
                    ...
                    echo '<a href="edit.php?action=send_req&id='.$user_data->id.'" class="req_actionBtn sendRequest">Edit Profile Information</a>';
                }
                ?>
